...
def main(argv):
    ...
    query_dir = 'C:\\Users\\Aradhana\\audioprocessing\\audio_split_txt'     # text to be aligned (e.g., result from speech api)
    ref_dir = 'C:\\Users\\Aradhana\\audioprocessing\\transcription'     # text to be aligned against (e.g., hand transcription)
    result_dir = 'result/'
    ...
    #
    wer_csv=open('wer_eval.csv','w')
    wer_csv.write('filename,# of errors,total words,wer\n')
        ...
        for filename in files:
            ...
            if filename.endswith('txt'):
                ...
                with open(query_file_path, 'r') as query_file, open(ref_file_path, 'r') as ref_file, open(rst_file_path, 'w+') as rst_file:
                    ...
                    csv_string=filename+','+str(errors)+','+str(len(ref_line_filtered_split))+','+str(errors/float(len(ref_line_filtered_split)))+'\n'
                    wer_csv.write(csv_string)
